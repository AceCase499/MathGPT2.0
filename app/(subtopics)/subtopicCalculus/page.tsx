...
import { subtopicsCalculus } from './subtopics';

const topics = [
    { id: nanoid(), name: 'Calculus', image: '/images/calculus.png', color: 'bg-pink-100', progress: 22 }
];
...
export default function SubtopicAlgebra2Page() {
    ...
    const [subTopicsState, setSubTopicsState] = useState(subtopicsCalculus);
    ...
    const toggleSubtopicFavorite = (id: string) => {
        ...
        const sortedSubtopics = [...updatedSubtopics].sort((a, b) => {
            ...
            return subtopicsCalculus.findIndex(sub => sub.id === a.id) - subtopicsCalculus.findIndex(sub => sub.id === b.id);
        });
