...
import { subtopicsPrecalculus } from './subtopics';

const topics = [
    { id: nanoid(), name: 'PreCalculus', image: '/images/precalculus.png', color: 'bg-pink-100', progress: 22 }
];
...
export default function SubtopicAlgebra2Page() {
    ...
    const [subTopicsState, setSubTopicsState] = useState(subtopicsPrecalculus);
    ...
    const toggleSubtopicFavorite = (id: string) => {
        ...
        const sortedSubtopics = [...updatedSubtopics].sort((a, b) => {
            ...
            return subtopicsPrecalculus.findIndex(sub => sub.id === a.id) - subtopicsPrecalculus.findIndex(sub => sub.id === b.id);
        });
