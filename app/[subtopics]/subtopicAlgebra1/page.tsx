...
import { subtopicsAlgebra1 } from './subtopics';

const topics = [
    { id: nanoid(), name: 'Algebra 1', image: '/images/algebra1.png', color: 'bg-pink-100', progress: 22 }
];

export default function SubtopicAlgebra1Page() {
    const initialTopics = [
    ...
    const [subTopicsState, setSubTopicsState] = useState(subtopicsAlgebra1);
    ...
    const toggleSubtopicFavorite = (id: string) => {
        ...
        const sortedSubtopics = [...updatedSubtopics].sort((a, b) => {
            ...
            return subtopicsAlgebra1.findIndex(sub => sub.id === a.id) - subtopicsAlgebra1.findIndex(sub => sub.id === b.id);
        });
